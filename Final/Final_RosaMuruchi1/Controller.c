...
int controller_loadFromTextFichaje(char* path, LinkedList* pArrayListEmployee)
{
    ...
    if(path != NULL && pArrayListEmployee != NULL)
    {
        ...
        if(archivo != NULL)
        {
            if(parser_EmployeeFromTextFichaje(archivo,pArrayListEmployee)==0)
            {
                retorno=0;
                printf("Se Cargo Los fichajes exitosamente!\n");
                //fclose(archivo);
            }
 ...
 *
 */
int controller_addEmployee(LinkedList* pArrayListEmployee,LinkedList* listaFichajes)
{
    int retorno=-1;

    if(pArrayListEmployee!=NULL)
    {
        if(employee_altaEmpleado(pArrayListEmployee,listaFichajes)==0)
        {
            retorno=0;
 ...
 *
 */
int controller_removeEmployee(LinkedList* pArrayListEmployee, LinkedList* pArrayListEmployee2)
{
    int retorno=-1;

    if(pArrayListEmployee!=NULL)
    {
        if(employee_bajaEmpleado(pArrayListEmployee, pArrayListEmployee2)==0)
        {
            retorno=0;
 ...
 *
 */
int controller_ListEmployee(LinkedList* pArrayListEmployee, LinkedList* listaFichaje)
{
    int retorno=-1;
    ...
    if(pArrayListEmployee!=NULL && listaFichaje!= NULL)
    {
        ...
        if(employee_listarEmpleado(pArrayListEmployee, listaFichaje)==0)
        {
            retorno=0;
            system("pause");
        }
    ...
    if(path != NULL && pArrayListEmployee != NULL)
    {
        ...
        if(archivoBin!=NULL)
        {
            for(i=0; i< ll_len(pArrayListEmployee); i++)
            {
                ...
                if(empleado!=NULL)
                {
                    fwrite(empleado,sizeof(Employee),1,archivoBin);
                }
            }
            retorno=0;
            fclose(archivoBin);
